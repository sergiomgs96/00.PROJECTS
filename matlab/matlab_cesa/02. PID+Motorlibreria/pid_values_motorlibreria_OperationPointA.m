...
% Operation Point A commands
% Speed = 5690 rpm
% motor_load = 167.8 %mN*m
duty_command = 0.5712 % 0 to 1 value, unused
speed_command = 3800 %RPM, Positive command makes motor turn on CW turn direction
motor_load = -251.26 %mN*m. Positive load makes motor turn on CW turn direction. Test made asume that the load is negative as long as it is oposing to the motor movement (Which is positive)
