...
% Operation Point B commands
% Speed = 5690 rpm
% motor_load = 167.8 %mN*m
duty_command = 0.835 % 0 to 1 value, unused
speed_command = 5690 %RPM, Positive command makes motor turn on CW turn direction
motor_load = -167.8 %mN*m. Positive load makes motor turn on CW turn direction
